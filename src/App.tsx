...
const CATEGORY_GROUPS = [
  ...
  { id: 'humanities', name: 'Humanities & Govt', icon: <Building className="w-6 h-6"/>, topics: ['History', 'Geography', 'Political Science', 'Indian Constitution', 'Preamble of the Constitution', 'Parts of the Constitution', 'Schedules of the Constitution', 'Amendments of the Constitution', 'Indian Penal Code', 'Bare Acts (IPC, CrPC, CPC)', 'UPSC', 'NDA', 'Teacher', 'Journalist'] },
